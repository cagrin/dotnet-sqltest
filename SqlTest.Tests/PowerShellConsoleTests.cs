...
public class PowerShellConsoleTests
{
    ...
    public void InvokeSqlTestErrorWithMock()
    {
        ...
        _ = PowerShellConsole.Invoke("dotnet SqlTest.dll --error", mock.Object);
    ...
    {
        var results = PowerShellConsole.Invoke("dotnet SqlTest.dll --error");
    ...
    {
        var results = PowerShellConsole.Invoke("dotnet SqlTest.dll --version");
    ...
    {
        var results = PowerShellConsole.Invoke("dotnet SqlTest.dll --help");
