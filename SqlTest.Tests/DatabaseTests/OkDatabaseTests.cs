...
public class OkDatabaseTests : BaseDatabaseTests
{
    ...
    {
        var results = PowerShellConsole.Invoke($"dotnet SqlTest.dll runall --image {image} --project {this.Folder}/Ok\n$LASTEXITCODE");
    ...
    {
        var results = PowerShellConsole.Invoke($"dotnet SqlTest.dll runall --image {image} --project {this.Folder}/Ok --cc-include-tsqlt\n$LASTEXITCODE");
    ...
    {
        var results = PowerShellConsole.Invoke($"dotnet SqlTest.dll runall --image {image} --project {this.Folder}/Ok --cc-disable\n$LASTEXITCODE");
    ...
    public void InvokeSqlTestRunAllOkWithXmlResult(string image)
    {
        ...
        _ = PowerShellConsole.Invoke($"dotnet SqlTest.dll runall --image {image} --project {this.Folder}/Ok --result {filename}");
